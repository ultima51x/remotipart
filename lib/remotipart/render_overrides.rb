  ...
  module RenderOverrides
    ...
    def render_with_remotipart *args
      ...
      if remotipart_submitted?
        ...
        response.body = %{<script>document.domain="#{AppConfig.lowered_domain}";</script><textarea data-type=\"#{response.content_type}\" data-status=\"#{response.response_code}\" data-statusText=\"#{response.message}\">#{textarea_body}</textarea>}
